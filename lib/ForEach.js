...
ForEach.topLevelAsync = async function(gltf, name, handler) {
...
ForEach.imageAsync = async function(gltf, handler) {
    return await ForEach.topLevelAsync(gltf, 'images', handler);
};
